<?php
    ...
    */
    ...
    if(isset($_POST['save'])){
        ...
        if($lease->fetch($_GET['id'])){

        $data=$lease->fetch($_GET['id']);
        //sanitize user inputs
        $lease->p_unit_id = $data['p_unit_id'];
        $lease->tenants_id = $data['tenants_id'];
        $lease->type = $data['type'];
        $lease->description_p = $data['rent'];
        $lease->rent = $data['rent'];
        $lease->unit_condition = $data['unit_condition'];
